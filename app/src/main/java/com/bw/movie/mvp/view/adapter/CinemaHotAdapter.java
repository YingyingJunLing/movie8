...
public class CinemaHotAdapter extends XRecyclerView.Adapter<CinemaHotAdapter.MyViewHolder> {
    private Context context;
    private List<HotMovieBean.ResultBean> list;
    private View view;

    public CinemaHotAdapter(Context context, List<HotMovieBean.ResultBean> list) {
