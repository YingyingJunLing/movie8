...
public class FindAllCinemaAdapter extends XRecyclerView.Adapter<FindAllCinemaAdapter.MyViewHolder> {
    private Context context;
    private List<FindAllCinemasBean.ResultBean> list;
    private View view;

    public FindAllCinemaAdapter(Context context, List<FindAllCinemasBean.ResultBean> list) {
